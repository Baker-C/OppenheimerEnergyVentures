...
export default function Home() {
  ...
  useEffect(() => {
    const t = setTimeout(() => setShowLineDot(true), 2800);
            ...
            <div className="space-y-14 sm:space-y-18 px-6 lg:px-0">
              {home.intro.quote && (
                <div className="space-y-5">
                  <p className={`fade-up text-center italic text-gray-600 text-lg sm:text-xl md:text-2xl max-w-4xl mx-auto`} style={{ animationDelay: `1800ms` }}>
                    “{home.intro.quote.text}”
                  </p>
                  {home.intro.quote.author && (
                    <p className={`fade-up text-center italic text-lg sm:text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto`} style={{ animationDelay: `2000ms` }}>
                      — {home.intro.quote.author}
                    </p>
                  )}
                </div>
              ...
              {home.intro.copy && home.intro.copy.map((line, idx) => (
                <p
                  ...
                  style={{ animationDelay: `${3400 + idx * 180}ms` }}
                >
                  {line}
                </p>
              ))}
